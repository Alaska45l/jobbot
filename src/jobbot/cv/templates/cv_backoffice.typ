// ─────────────────────────────────────────────────────────────────────────────
// cv_backoffice.typ — Back Office · E-commerce · Operaciones
...
// ── Contacto en fila horizontal (sin GitHub) ────────────────────────────────
...
// ═════════════════════════════════════════════════════════════════════════════
//  EXPERIENCIA ADMINISTRATIVA Y OPERATIVA
// ═════════════════════════════════════════════════════════════════════════════

#section-title[💼 Experiencia administrativa y operativa]
...
#section-title[🛠️ Herramientas y competencias]
